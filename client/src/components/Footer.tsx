    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-xl tracking-tight">URBANIEGH</span>
                </div>
                <p className="text-gray-400 text-sm leading-relaxed">
                    Redefining comfort with premium cotton essentials. Designed for modern living, crafted for everyday luxury.
                </p>
            ...
            <div>
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                    ...
                    <li><Link to="/shop?sort=best_selling" className="hover:text-white transition-colors">Best Sellers</Link></li>
            ...
            <div>
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                    ...
                    <li><Link to="/cart" className="hover:text-white transition-colors">Track Order</Link></li>
            ...
            <div>
                ...
                <ul className="space-y-4 text-sm text-gray-400">
                    <li className="flex items-start gap-3">
                        ...
                        <span>123 Fashion Street, Tech Park,<br/>Bangalore, India 560001</span>
                    </li>
                    ...
                    <li className="flex items-center gap-3">
                        <Mail size={18} />
                        <span>support@urbaniegh.com</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
            <p>&copy; {new Date().getFullYear()} Urbaniegh. All rights reserved.</p>
